  ...
  return (
    <section className="rounded-3xl mt-10 py-12 bg-[#1F473E] flex justify-center text-center items-center px-4 w-11/12 mx-auto mb-12 md:w-10/12 lg:w-9/12">
      <div className="max-w-4xl">
        ...
        >
          Plans Only Matter When We Act <br /> Together
        </motion.h2>
        ...
        >
           Join us, share your ideas, and help bring these plans to life. Every step forward is{" "}
          <br className="hidden sm:block" /> stronger with you in it.
        </motion.p>
